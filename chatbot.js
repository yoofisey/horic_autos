...
window.RhuleAdvisor = { open: () => RhuleChatbot.toggleChat(), close: () => RhuleChatbot.toggleChat(), submit: (msg) => RhuleChatbot.sendMessage(msg) };
